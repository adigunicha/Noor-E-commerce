<template>
    <div>
  <nav class="flex justify-between items-center flex-row py-5 px-12 shadow-sm bg-white ">
    <NuxtLink to="/">
  ...
  <div class="button m-5 flex items-center justify-center">
    ...
    <NuxtLink class="btn shadow-sm" to="/product/section2">2</NuxtLink>
  </div>
